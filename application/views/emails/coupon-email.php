    ...
    <tbody>
      ...
      <tr>
        <td style="padding: 0px 20px 20px 20px;">
          <h1 style="color: #133F53; margin: 0px; font-family: Arial, Helvetica, 'sans-serif'; font-size: 25px;">Enjoy your credits!</h1>
          <p style="color: #133F53; font-family: Arial, Helvetica, 'sans-serif'; font-size: 15px; text-align: left;">
            ...
            You've just been given credits!</p>
            <p style="color: #133F53; font-family: Arial, Helvetica, 'sans-serif'; font-size: 15px; text-align: left;">
				<b>$<?php echo number_format($amount, 2); ?></b> in credits for <b><?php echo ucfirst($coupon); ?></b></p><br>
        </td>
      </tr>
      <tr>
