		...
		<tbody>
			...
			<tr>
				<td style="padding: 0px 20px 20px 20px;">
					...
					<h2 style="color: #397191; margin-top: 0px; font-family: Arial, Helvetica, 'sans-serif'; font-size: 19px; font-weight: 300;">Edit Requires Your Attention.</h2>
					<p style="color: #133F53; font-family: Arial, Helvetica, 'sans-serif'; font-size: 15px; text-align: left">
						...
						A user, <?php echo ucfirst($username); ?>, has requested an edit to their created beneficiary: <?php echo ucfirst($beneficiary->name); ?>.
					</p><br>
