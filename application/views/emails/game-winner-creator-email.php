    ...
    <tbody>
      ...
      <tr>
        <td style="padding: 0px 20px 20px 20px;">
          <h1 style="color: #133F53; margin: 0px; font-family: Arial, Helvetica, 'sans-serif'; font-size: 25px;">Winners have been selected!</h1>
          ...
          <p style="color: #133F53; font-family: Arial, Helvetica, 'sans-serif'; font-size: 15px; text-align: left">
            ...
            <?php if (!$review) { ?>
              Winners have been selected for your game, <?php echo ucfirst($name); ?>!
            <?php } else { ?>
              You've successfully selected winners for your game, <?php echo ucfirst($name); ?>!
            <?php } ?>
            <br><br>If your game rewards players with prizes, players will have to claim their prize before any additional action is required. Check your dashboard to stay updated!
          </p><br>
