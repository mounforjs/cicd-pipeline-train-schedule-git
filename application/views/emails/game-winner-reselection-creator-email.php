    ...
    <tbody>
      ...
      <tr>
        <td style="padding: 0px 20px 20px 20px;">
          <h1 style="color: #133F53; margin: 0px; font-family: Arial, Helvetica, 'sans-serif'; font-size: 25px;">Winners have been reselected!</h1>
          ...
          <p style="color: #133F53; font-family: Arial, Helvetica, 'sans-serif'; font-size: 15px; text-align: left">
            ...
            We had to reselect some winners for your game, <?php echo ucfirst($name); ?>. <br><br>We attempted to contact your previous winners for a week prior to the end of your game, but received no response. Your new winners will also have a week to respond and claim their prize. 
