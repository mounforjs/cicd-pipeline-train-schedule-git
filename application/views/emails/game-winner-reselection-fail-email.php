    ...
    <tbody>
      ...
      <tr>
        <td style="padding: 0px 20px 20px 20px;">
          <h1 style="color: #133F53; margin: 0px; font-family: Arial, Helvetica, 'sans-serif'; font-size: 25px;">We weren't able to reselect winners!</h1>
          <h2 style="color: #397191; margin-top: 0px; font-family: Arial, Helvetica, 'sans-serif'; font-size: 19px; font-weight: 300;">Not enough players to select from!</h2>
          <p style="color: #133F53; font-family: Arial, Helvetica, 'sans-serif'; font-size: 15px; text-align: left">
            ...
            We had to reselect winners for your game, <?php echo ucfirst($name); ?>, but were unable to find additional winners. <br><br>To ensure all is well, your game will be manually reviewed by a staff member. We apologize for any inconvience and hope to have the issue resolved quickly.
