			...
			<tr>
				<td style="padding: 0px 20px 20px 20px;">
					...
					<p style="color: #133F53; font-family: Arial, Helvetica, 'sans-serif'; font-size: 15px; text-align: left">
						...
						Your new beneficiary, "<?php echo ucfirst($beneficiary->name); ?>", has been created and is pending approval. You will be unable to use the beneficiary until it's approved by our staff. We will be in touch if we need more information. 
						<br><br>
						If you have an questions, please contact us at: <a href="mailto:support@winwinlabs.org">support@winwinlabs.org</a>
					</p><br>
				</td>
			</tr>
			<tr>
