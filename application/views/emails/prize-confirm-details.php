    ...
    <tbody>
      ...
      <tr>
        <td style="padding: 0px 20px 20px 20px;">
          <h1 style="color: #133F53; margin: 0px; font-family: Arial, Helvetica, 'sans-serif'; font-size: 25px;">You're a winner, claim your prize!</h1>
          <h2 style="color: #397191; margin-top: 0px; font-family: Arial, Helvetica, 'sans-serif'; font-size: 19px; font-weight: 300;">There's not much time left!</h2>
          <p style="color: #133F53; font-family: Arial, Helvetica, 'sans-serif'; font-size: 15px; text-align: left">
            ...
            You're a winner for the game, <?php echo ucfirst($name); ?>, supporting <?php echo ucfirst($charity); ?>. <br><br>You have <?php echo $remainingTime; ?> left to claim a prize you won! Login to confirm your details!
          </p><br>
          <a href="<?php echo asset_url('games/show/completed/' . $slug); ?>" style="color: black; background-color: #ffa000; padding: 10px; font-size: 15px; font-family: Arial, Helvetica, 'sans-serif'; text-decoration: none; background: linear-gradient(0deg, rgba(255, 160, 0, 1) 49%, rgba(255, 177, 46, 1) 50%);">Click to Confirm!</a><br><br>
        </td>
      </tr>
      <tr>
