    ...
    <tbody>
      ...
      <tr>
        <td style="padding: 0px 20px 20px 20px;">
          <h1 style="color: #133F53; margin: 0px; font-family: Arial, Helvetica, 'sans-serif'; font-size: 25px;">You failed to ship a prize!</h1>
          <h2 style="color: #397191; margin-top: 0px; font-family: Arial, Helvetica, 'sans-serif'; font-size: 19px; font-weight: 300;">We've been notifying you for 10 days!</h2>
          <p style="color: #133F53; font-family: Arial, Helvetica, 'sans-serif'; font-size: 15px; text-align: left">
            ...
            You had 10 days to begin processing and shipping a player's prize for the game, <?php echo ucfirst($name); ?>! <br><br>To ensure all is well, your game will be manually reviewed by a staff member. We apologize for any inconvience and hope to have the issue resolved quickly.
